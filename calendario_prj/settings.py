"""
Django settings for calendario_prj project.
...
SECRET_KEY = 'django-insecure-@hhh61_xak0lm+c=2g-**%3l!!erlnv-cmq(^r$r2u5s+##t9v'
...
ROOT_URLCONF = 'calendario_prj.urls'
...
WSGI_APPLICATION = 'calendario_prj.wsgi.application'
